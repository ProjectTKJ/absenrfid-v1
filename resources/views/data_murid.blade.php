...
<div>
    ...
    <input type="text" class="form-control" id="addNama" name="nama" placeholder="Enter Nama Murid" required>
</div>
...
function showTable(data){
    ...
    for(let x = 0; x < data.length; x++){
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-primary btn-sm edit-btn" data-id="`+data[x].id_murid+`" data-kelas="`+data[x].kelas.kelas+`" data-kartu="`+data[x].id_kartu+`" data-nama="`+data[x].nama+`" data-toggle="modal" data-target="#modalEdit">Edit</button>
